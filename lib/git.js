    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (action.lfs) {
                ...
                yield execute_1.execute(`git lfs pull`, action.workspace, action.silent);
                yield execute_1.execute(`git lfs migrate export --include="*"`, action.workspace, action.silent);
            }
