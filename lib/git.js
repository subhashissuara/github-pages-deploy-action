    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                core_1.info('Unable to remove origin, skipping…');
            }
            ...
            if (action.preserve) {
                core_1.info(`Stashing workspace changes…`);
                yield execute_1.execute(`git stash`, action.workspace, action.silent);
            }
            yield execute_1.execute(`git fetch --no-recurse-submodules`, action.workspace, action.silent);
        ...
        try {
            ...
            if (action.preserve) {
                ...
                try {
                    ...
                    core_1.info('Unable to apply stash, skipping…');
                }
            }
            ...
            if (action.preserve) {
                core_1.info(`Restoring workspace changes…`);
                yield execute_1.execute(`git stash apply`, action.workspace, action.silent);
            }
            ...
            yield execute_1.execute(`ls ${action.folder}`, action.workspace, false);
            /*
